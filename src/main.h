...
public:
    ...
    {
        // Transboundarycoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Transboundarycoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Transboundarycoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Transboundarycoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Transboundarycoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Transboundarycoin: block index flags
    enum  
    {
