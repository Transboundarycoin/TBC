...
const QString BITCOIN_IPC_PREFIX("Transboundarycoin:");
...
{
    QString name("TransboundarycoinQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Transboundarycoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Transboundarycoin: click-to-pay handler");
    else
...
{
    // clicking on Transboundarycoin: URLs creates FileOpen events on the Mac:
